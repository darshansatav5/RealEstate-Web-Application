...
<head>
  ...
  <style>
    ...
    /* Show logout button when the profile icon is clicked */
    .profile-icon.clicked .logout-button {
      display: block;
    }
  ...
  <header class="header" data-header>
    ...
    <div class="header-top">
      <div class="container">
        ...
        <div class="wrapper">
         <button class="header-top-btn"> <a href="login"> Login</a></button>       
        </div>
              ...
              <div class="property-card">
                ...
                <div class="card-content">
                  ...
                  <div class="card-price">
                    <strong>28,900</strong>/Month
                  </div>

                  <h3 class="h3 card-title">
                    <a href="p-1">New Apartment Nice View</a>
                  </h3>
              ...
              <div class="property-card">
                ...
                <div class="card-footer">
                  ...
                  <div class="card-author">
                    ...
                    <figure class="author-avatar">
                      <img src="./assets/images/service-2.png" alt="William Seklo" class="w-100">
                    </figure>

                    <div>
                      <p class="author-name">
                        <a href="#">Bhowmik Realtors</a>
                      </p>
                ...
                <figure class="card-banner">
                  ...
                  <div class="banner-actions">
                    ...
                    <button class="banner-actions-btn">
                      ...
                      <address>Magarpatta, Pune</address>
                    </button>
          ...
          <ul class="features-list">
            ...
            <li>
              <a href="#" class="features-card">
                ...
                <h3 class="card-title">Kids Playland</h3>
                ...
                <div class="blog-content">
                  ...
                  <div class="blog-content-bottom">
                    <div class="publish-date">
                      ...
                      <time datetime="2022-27-04">Oct 12, 2023</time>
                    </div>
                ...
                <div class="blog-content">
                  ...
                  <div class="blog-content-bottom">
                    <div class="publish-date">
                      ...
                      <time datetime="2022-27-04">June 16, 2023</time>
                    </div>
      ...
      <div class="container">
          ...
          <ul class="contact-list">
            ...
            <li>
              <a href="contact" class="contact-link">
                ...
                <address>Shivaji Nagar, Pune, Maharashtra</address>
              </a>
            </li>
        ...
        <div class="footer-link-box">
          ...
          <ul class="footer-list">
            ...
            <li>
              <a href="track" class="footer-link">Order tracking</a>
            </li>

            <li>
              <a href="list" class="footer-link">Wish List</a>
            </li>
            ...
            <li>
              <a href="t&c" class="footer-link">Terms & Conditions</a>
            </li>

            <li>
              <a href="offer" class="footer-link">Promotional Offers</a>
            </li>
